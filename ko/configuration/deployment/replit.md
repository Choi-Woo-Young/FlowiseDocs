...
6. Type in `npm install -g flowise` into the Shell terminal window. If you are having 오류 about incompatible node version, use the following command `yarn global add flowise --ignore-engines`
