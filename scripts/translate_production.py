#!/usr/bin/env python3
"""
Production Flowise Documentation Translator - English to Korean
Smart translation with proper YAML handling and sentence-level translation
"""
...
TRANSLATION_DICT = {
    ...
    # LangChain Integration sections
    'LangChain': 'LangChain',
    'Agents': '에이전트',
...
class TextTranslator:
    ...
    def should_preserve_as_english(text: str) -> bool:
        ...
        # These are full sentence paragraphs that should stay in English
        # unless they're just headings or simple list items
